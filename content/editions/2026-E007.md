...
- **Newsletter → self-hosted.** Freed from Beehiiv dependency. The archive lives on the website now — [7 editions](https://squaer.co/brief), published when there's something worth publishing. No more scheduling for scheduling's sake.
...
- **Five agent names → five cognitive functions.** SERAPHIM, CHRONICLE, AESTHETE, SENTINEL — internal engine names nobody outside the system knew. Now they're functions: STRATEGIC, EDITORIAL, VISUAL, DISTRIBUTION, INTEGRITY. The brand is SQUAER. One agent.
